...
export default function VisualizerSection({
  ...
  return (
    ...
    >
      {tab === "exterior" ? (
        <div
          className="absolute inset-0 select-none touch-pan-y bg-white bg-center bg-no-repeat"
          style={{
            backgroundImage: "url('/images/spinback.png')",
            backgroundSize: "130%", // zoomed to match the car, same as the old version
            cursor: SPIN_CURSOR,
          }}
